  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between px-16 py-4">
        <div className="flex font-medium items-center space-x-10">
        ...
        <button onClick={()=>router.push("/signin")} className="bg-[#FFB74D] border border-[#334679] px-6 py-3 rounded-md font-medium">
          Sign in
        </button>
      </div>

      <div className="flex pl-16 overflow-hidden pt-20 gap-20">
        <div className="w-2/3 pt-6">
          <h1 className="text-4xl md:text-5xl drop-shadow-md font-extrabold ">
        ...
        <div className="relative border border-gray-900 bg-white p-6 rounded-md w-[50%] translate-x-[20%] ">
          {/* Grid Inside */}
